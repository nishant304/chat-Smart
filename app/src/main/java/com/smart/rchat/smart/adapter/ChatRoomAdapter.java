...
public class ChatRoomAdapter extends CursorAdapter {
    ...
    public void bindView(View view, final Context context, Cursor cursor) {
        ...
        if (type == 1) {
            handleMessageView(view, context, cursor, from);
        } else if (type == 2) {
            handleImageView(view, context, cursor, from);
        } else {
            handleContactView(view, context, cursor, from);
        }
    ...
    protected void handleContactView(View view, final Context context, Cursor cursor, String from) {
    ...
    public void setUserNameMapping(HashMap<String,String> hashMap){
        this.hashMap = hashMap;
    }

    protected HashMap<String,String> getUserIdMapping(){
        return hashMap;
    }
